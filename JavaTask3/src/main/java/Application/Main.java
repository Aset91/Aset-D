...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        private static void printAllOverdueSecurities (List<Organization> organizationList) {
            List<Securities> overdueSecurityList = SecurityService.getAllOverdueSecurities(organizationList);
        ...
        private static void printAllSecuritiesByCurrency (List <Organization> organizationList) {
            ...
            List<Securities> securityList = SecurityService.getAllSecuritiesByCurrency(organizationList, userCurrency);
